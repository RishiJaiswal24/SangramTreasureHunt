    ...
    return (
        <main className="flex flex-col items-center justify-center text-center min-h-[80vh] px-6 text-white">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl leading-relaxed text-lg animate-fadeIn max-w-2xl">
                <div>
                    I am the blossoming promise found on the ground’s near side,
                    nearest the entryway, but always its pride.
                </div>
                <div>
                    I hold the shade of dawn, though I am born in the dust,
                    a soft living arrow pointing where journey starts.
                </div>
                <div>
                    My color is love, but my destination is strict;
                    I am the immediate left of what is permanently fixed.
                </div>
            </div>
